...
| Recording all exceptions inside the catch statement also records simple exceptions such as `UserNotRegistedException`,  `UserNotSignedInException`                                                                                                                   | We can configure what to do with the 2 types of EaseFailure this package offers. EaseException and EaseError                                                         |
...
## How to use?
### Step 1 - [Global EaseFailure Configuration](#global%20configuration)
...
> [!NOTE]
> These [EaseEither](#EaseEither) methods returns the type `Either<EaseFailure, T>` which forces us to handle both success and failure case.
